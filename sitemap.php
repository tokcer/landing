...
a
                ...
                if (!empty($subDirectory)) {
                    // Create a subdirectory for each name and add sitemap.xml
...
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Create Directories and HTML Files - MABUKYUK</title>
    <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.5.2/css/bootstrap.min.css">
...
<body>
    ...
    <footer>
        &copy; 2024 MABUKYUK. All rights reserved.
    </footer>
